...
public class ScatheMoveState : MoveState
{
    ...
    {
        Transform targetTransform = GameObject.FindAnyObjectByType<ScatheTargetPos>().transform;
        ...
        Vector2 target = new Vector2(targetTransform.position.x, targetTransform.position.y) + Vector2.up * heightOffset;
        ...
        Vector2 directionToPlayer = new Vector2(targetTransform.position.x - enemy.transform.position.x, targetTransform.position.y - enemy.transform.position.y);
